...
/* Viene creata una vista per ottenere tutte le notizie da trasmettere
*/
CREATE OR REPLACE FORCE VIEW "GRUPPO_AZZURRO"."TRASMETTI_VIEW" ("ID", "TITOLO", "SOTTOTITOLO", "AUTORE", "ULTIMO_DIGITATORE", "TESTO", "LUNGHEZZA_TESTO", "DATA_CREAZIONE", "STATO", "BLOCCO")
AS
  SELECT id,
    TITOLO,
    SOTTOTITOLO,
...
INSERT INTO "GRUPPO_AZZURRO"."FUNZIONALITA" (SIGLA_FUNZIONALITA,NOME_FUNZIONALITA) VALUES ('Ann','Annulla Tutte Le Modifiche');
INSERT INTO "GRUPPO_AZZURRO"."FUNZIONALITA" (SIGLA_FUNZIONALITA,NOME_FUNZIONALITA) VALUES ('RiattAcc','Riattiva Account');
...
INSERT INTO "GRUPPO_AZZURRO"."GRUPPO_FUNZIONALITA" (NOME_GRUPPO, SIGLA_FUNZIONALITA) VALUES ('Amministratore','RiattAcc');
